...
use \WM\Sberbank\Exception\ActionException;
use \WM\Sberbank\Exception\BadResponseException;
use \WM\Sberbank\Exception\NetworkException;
use \WM\Sberbank\Exception\ResponseParsingException;
use \WM\Sberbank\HttpClient\CurlClient;
use \WM\Sberbank\HttpClient\HttpClientInterface;
use \WM\Sberbank\OrderStatus;
...
class Client
{
    ...
    public function getLastOrdersForMerchants(\DateTime $from, \DateTime $to = null, array $data = array())
    {
        ...
        $data['transactionStates'] = array_map('\WM\Sberbank\OrderStatus::statusToString', $data['transactionStates']);
