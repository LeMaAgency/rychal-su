...
if (empty($arResult['ITEMS']))
    return;
?>
<div class="features-items col-md-offset-2 col-sm-6 col-md-5 col-lg-5">
    ...
    <? if (($iKey + 1) > ceil($iQuantityOfElements / 2)) { ?>
        <div class="features-item features-item-composition animated mov" id="<?= $this->GetEditAreaId($arItem['ID']); ?>">
